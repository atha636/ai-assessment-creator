...
function AssignmentTitle(a: Assignment) {
    ...
    >
      ...
      <div style={{
        ...
        <span style={{ fontSize: 12, color: "var(--text-muted)", fontFamily: "var(--font-body)" }}>
          <strong style={{ color: "var(--text-secondary)" }}>Assigned on</strong> :{" "}
          {formatDate(assignment.createdAt)}
        </span>
        <span style={{ fontSize: 12, color: "var(--text-muted)", fontFamily: "var(--font-body)" }}>
          <strong style={{ color: "var(--text-secondary)" }}>Due</strong> :{" "}
...
export default function AssignmentsPage() {
  ...
  const filtered = assignments.filter((a) => {
    const title = AssignmentTitle(a).toLowerCase();
