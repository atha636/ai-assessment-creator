    ...
    <div className="animate-fade-up" style={{ maxWidth: 860, margin: "0 auto" }}>
      ...
      >
        ...
        <div style={{
          ...
          {[
            { label: "Name", value: studentName, setter: setStudentName, placeholder: "________________" },
            { label: "Roll Number", value: rollNumber, setter: setRollNumber, placeholder: "________________" },
            { label: "Class/Section", value: sectionName, setter: setSectionName, placeholder: "________________" },
        ...
        <div style={{ padding: "28px 36px" }}>
          {result.sections?.map((section: any, si: number) => (
            <div key={si} style={{ marginBottom: 36 }} className={`animate-fade-up delay-${si + 1}`}>
              {/* Section header */}
              <div style={{
                display: "flex",
                alignItems: "baseline",
